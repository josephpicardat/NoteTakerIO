...
const handleNoteSave = () => {
    ...
    // If the note already has an ID, update it on the server
    if (activeNote.id) {
        ...
        // Otherwise, create a new note on the server
        saveNote(newNote).then(() => {
            activeNote = newNote;
            getAndRenderNotes();
            renderActiveNote();
...
// add event listeners to enable/disable the save button based on input // UPDATED
